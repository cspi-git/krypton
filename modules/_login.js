...
function login(krypton, readLine, request){
    return new Promise((resolve)=>{
        async function final(){
            ...
            if(loginResponse.status === "failed"){krypton.log("e", "Invalid username/password.");return banner()}
        ...
        function password(){
            ...
            if(!passwordInput){krypton.log("e", "Invalid username/password.");return banner()}
        ...
        function username(){
            ...
            if(!usernameInput){krypton.log("e", "Invalid username/password.");return banner()}
        ...
        function banner(){
            setTimeout(()=>{console.clear(); kryptonModule.randomBanner(); username()}, 3000)
        }
