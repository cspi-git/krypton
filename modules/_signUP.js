...
function login(krypton, readLine, request){
    return new Promise((resolve)=>{
        ...
        async function final(){
            ...
            krypton.log("i", "Signing up, please wait...")
            ...
            if(loginResponse.status === "failed"){krypton.log("e", "Invalid code.");return banner()}
            if(loginResponse.status === "success"){
                krypton.log("i", "Account successfully created (Automatic Login).")
                setTimeout(()=>{
                    resolve()
                }, 3000)
            }else{
                krypton.log("e", loginResponse.message)
                banner()
            }
        }
        ...
        function code(){
            ...
            if(!codeInput){krypton.log("e", "Invalid code.");return banner()}
        ...
        function password(){
            ...
            if(!passwordInput){krypton.log("e", "Invalid password.");return banner()}
        ...
        function username(){
            ...
            if(!usernameInput){krypton.log("e", "Invalid username.");return banner()}
        ...
        function banner(){
            setTimeout(function(){console.clear();kryptonModule.randomBanner();username()}, 3000)
        }
